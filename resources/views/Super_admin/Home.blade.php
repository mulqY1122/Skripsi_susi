...
<p class="mb-0 fs-6">
    Selamat datang kembali, <strong>Super Admin</strong>! <br>
...
<div class="row row-cols-1 row-cols-md-3 g-4 mb-4">
    <div class="col">
      <div class="text-white p-4 rounded-5 shadow-lg text-center position-relative overflow-hidden" style="background: linear-gradient(135deg, #90fa84, #85ce85, #389c4b); border-radius: 1.5rem;">
        <i class="bi bi-bar-chart-line-fill fs-1"></i>
        <h5 class="fw-semibold mt-2">Jumlah Bank Sampah</h5>
        <p>12</p>
        ...
        <!-- Decorative SVG Wave -->
        <svg viewBox="0 0 1440 150" preserveAspectRatio="none" style="position: absolute; bottom: 0; left: 0; height: 50px; width: 100%; z-index: 0;">
          <path d="M0,0 C360,100 1080,0 1440,100 L1440,150 L0,150 Z" style="fill: rgba(255, 255, 255, 0.1);"></path>
        </svg>
      </div>
    </div>
    <div class="col">
      <div class="text-white p-4 rounded-5 shadow-lg text-center position-relative overflow-hidden" style="background: linear-gradient(135deg, #90fa84, #85ce85, #389c4b); border-radius: 1.5rem;">
        ...
        <h5 class="fw-semibold mt-2">Jumlah Ketua RW</h5>
        <p>5</p>
        <div class="progress" style="height: 5px;">
    ...
    <div class="col">
      <div class="text-white p-4 rounded-5 shadow-lg text-center position-relative overflow-hidden" style="background: linear-gradient(135deg,#16d800, #439b43, #69c079); border-radius: 1.5rem;">
        <i class="bi bi-person-check-fill fs-1"></i>
        <h5 class="fw-semibold mt-2">Jumlah Nasabah</h5>
        <p>8</p>
        <div class="progress" style="height: 5px;">
  ...
  <style>
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="card shadow rounded-5 h-100">
          <div class="card-header text-white rounded-top-5" style="background: linear-gradient(135deg, #16d800, #439b43, #83ec96);">
            <h5><i class="bi bi-clock-history me-2"></i>Jagalah lingkungan</h5>
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-lg-4">
        @php
          $laporanBulanan = \App\Models\LaporanBulanan::select('nama_sampah', \DB::raw('SUM(berat) as total_berat'))
              ->groupBy('nama_sampah')
              ->get();
          $totalBerat = $laporanBulanan->sum('total_berat');
          $progress = min($totalBerat / 1000 * 100, 100);
        @endphp
        <div class="card shadow rounded-5 h-100">
          <div class="card-header text-white rounded-top-5" style="background: linear-gradient(135deg, #d4f5d0, #a0e6a0, #79d38a);">
            <h5><i class="bi bi-box me-2"></i>Laporan Sampah Bulanan</h5>
          </div>
          <div class="card-body">
            <h3>Total Berat Sampah: {{ $totalBerat }} kg</h3>
            <p class="text-muted">
            ...
            <ul class="list-group mt-3">
              @foreach ($laporanBulanan as $item)
                <li class="list-group-item d-flex justify-content-between">
                  {{ $item->nama_sampah }}
                  <span class="badge bg-success">{{ $item->total_berat }} kg</span>
                </li>
              @endforeach
            </ul>
          </div>
    ...
    <div class="card shadow rounded-5">
      <div class="card-header text-white rounded-top-5" style="background: linear-gradient(135deg, #d4f5d0, #a0e6a0, #79d38a);">
        <h5><i class="bi bi-list-task me-2"></i>Task List</h5>
      </div>
      <div class="card-body">
        <ul class="list-group">
          <li class="list-group-item d-flex justify-content-between">
            Wash the car <span class="badge bg-danger">Rejected</span>
          </li>
          <li class="list-group-item d-flex justify-content-between">
            Task with dropdown <span class="badge bg-secondary">Options</span>
          </li>
          <li class="list-group-item d-flex justify-content-between">
            Badge on the right <span class="badge bg-info">Info</span>
          </li>
        </ul>
      </div>
    </div>
